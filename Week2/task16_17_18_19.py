...
print(f"""{s[0],s[7],s[-3],len(s),s[16],
...
print(f"s[-3:-6]: {s[-3:-6]} -> An empty string because slicing from -3 to -6 with a default positive step is invalid.")
print(f"s[-6:-3]: {s[-6:-3]} -> Substring from the 6th-to-last character to just before the 3rd-to-last character.")
...
print(f"s[5:500]: {s[5:500]} -> Substring starting from index 5 to the end (no IndexError for out-of-range).")
