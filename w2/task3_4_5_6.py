...
try:
    ...
    print(
        "!!!The Testing Case for list didnt print cause the boolean var \n is not of an iterable thing to iterate over!!!\n\n"
    )
...
try:
    print(
        f"The Value of a is = {a:7} , as float   = {float(a)} and as string = {str(a)}"
    )
    print(
        f"The Value of b is = {b:5.5f} , as integer = {int(b)}   and as string = {str(b)}"
    )
    print(
        f"The Value of c is = {c:5.5f} , as integer = {int(c)}   and as string = {str(c)}"
    )
    print(
        f"The Value of e is = {e:5.5f} , as float   = {float(a)} and as list   = {list(a)}"
    )
except TypeError:
    print(
        "!!!The Testing Case for (e) didnt print cause the boolean var \n is not of an iterable thing to iterate over!!!\n\n"
    )
